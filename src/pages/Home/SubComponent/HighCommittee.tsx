      ...
      <div className="container items-center xl:items-center mx-auto w-full h-full flex-col py-4 md:px-16 ">
        <div className="w-full h-full flex flex-col justify-center items-center ">
            ...
            <div className="relative flex flex-col md:flex-row gap-8 animate-slidein100 mx-4  ">
              {highcommittees.slice(0, 2).map((Highcommittee) => (
                <div
                  ...
                  className="flex flex-col h-full items-center md:flex-row bg-black bg-opacity-60 to-white
                  p-4 rounded-lg shadow-2xl md:w-[calc(50%-16px)] transition-all ease-in-out duration-300 transform hover:scale-105 "
                >
                  {Highcommittee.image && (
                    <img
          ...
          <div className="flex flex-col items-center relative z-10 w-full  ">
            ...
            <div className="flex flex-col md:flex-row md:gap-8 animate-slidein100 mx-4 ">
              {highcommittees.slice(2).map((Highcommittee) => (
                <div
                  key={Highcommittee.id}
                  className="flex flex-col w-full h-full items-center mx md:flex-row bg-black to-white bg-opacity-60
