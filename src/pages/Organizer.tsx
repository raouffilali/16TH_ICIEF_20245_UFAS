...
const Organizer = () => {
  return (
    <div className="relative p-10 bg-gradient-to-br from-gray-50 via-white to-gray-50 text-gray-800 flex flex-col justify-center items-center">
      {/* Wavy Bottom Effect */}
      <img
      ...
      <h1 className="m-auto text-center text-green-800 text-4xl font-bold mb-6">
