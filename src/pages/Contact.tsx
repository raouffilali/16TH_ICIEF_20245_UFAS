...
const Contact = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col rounded-lg shadow-xl bg-gray-100 p-4 md:justify-between w-full max-w-[900px] gap-6">
          {/* Headline */}
          ...
          <div className="flex flex-col-reverse md:flex-row rounded-lg shadow-xl bg-gray-100 p-4 md:justify-between w-full gap-6">
            {/* Left Section (25%) */}
