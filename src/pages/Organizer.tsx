...
const Organizer = () => {
  ...
  return (
    <div className="relative pt-24 p-10 bg-gradient-to-br from-gray-50 via-white to-gray-50 text-gray-800 flex flex-col justify-center items-center">
      ...
      <table className="w-full max-w-[900px] border-collapse mt-6 shadow-xl">
        <thead>
          <tr className="bg-white animate-slidein100">
        ...
        <tbody>
          <tr className="bg-white animate-slidein200">
      ...
      <div className=" p-10 m-10 w-full max-w-[900px] bg-gradient-to-r from-uni-green2 via-uni-green2-light to-uni-green2 rounded-md text-transparent">
        <Carousel  
          ...
          {organizers.map((organizer) => (
             <CarouselItem key={organizer.id} className="flex flex-col items-center">
               ...
               {organizer.image && (
                ...
                <h3 className="text-xl font-bold text-white text-center">{organizer.name}</h3>
