  ...
  return (
    <div className="relative flex flex-col justify-center items-center w-full h-full px-6 py-20">
      ...
      />
        ...
        <h2 className="p-3 text-4xl md:text-7xl text-center font-bold mb-4 mt-5 animate-slidein200 bg-gradient-to-r from-uni-green2 via-uni-green2-light to-uni-green2 text-transparent 
          bg-clip-text">
            Steering Committee
          </h2>
            ...
            <div className="grid grid-col md:grid-cols-2 lg:grid-cols-3 gap-4 justify-center items-center md:gap-8  ">
              {steeringcommittees.map((steeringcommittee) => (
                <div
                  ...
                  className="flex flex-col w-full h-full max-w-[300px] items-center bg-gradient-to-br bg-white border-gray-600 drop-blur-lg border border-white to-uni-green2 bg-opacity-60
